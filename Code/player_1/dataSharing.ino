...
void sendBallData(){
  //TODO: mettre les valeurs de la balle dans la data pour l'envoyer
  // Prépare le message à envoyer
  ballMessageSent.ballX = balle.getBalleX();
  ballMessageSent.ballY = balle.getBalleY();
...
void onDataRecv(const esp_now_recv_info_t *info, const uint8_t *incomingData, int len) {
  ...
  if (id == 2 && len == sizeof(WinData)) {
    ...
    Serial.println();
    Serial.println("Donnée récupérée : P1 et P2 Connectés");
